                            ...
                            <div class="row">                                 
                                ...
                                <div class="col-md-2">                   
                                    ...
                                    <select class="form-control select2" onchange="funLoadAllChart()" id="id_Select_Category" style="width: 100%;">
                                        ...
                                        <option value="Machine Spare Part Order">Machine Spare Part Order</option> 
                                        <option value="Service">Service</option> 
                                        <option value="Other">Other</option> 
                                        <option value="Material Order">Material Order</option> 
                                        <option value="New Modification">New Modification</option> 
                                        <option value="Repair Item">Repair Item</option> 
                                        <option value="New Fabrication">New Fabrication</option> 
                                        <option value="Supply line Modification">Supply line Modification</option> 
                                        <option value="New Wiring Requirement">New Wiring Requirement</option>
    ...
    { 
        ...
        $.post('getData_OtherReport.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                ...
                const AryCheckIn_Lable      = res.Data_Ary[0];//["Repair", "Maintenance", "Machine Spare Part Order","Service", "Other","Material Order","New Modification","Repair Item","New Fabrication","Supply line Modification","New Wiring Requirement"]; 
