                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default" >
                        <div class="card-header">
                            <h3 class="card-title">Mechanic Job History Details </h3>
                            ...
                            <div class="row">                                 
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select class="form-control" id="id_SelMechanics">
                                ...
                                <div class="col-md-2">    
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="id_Checkbox1" onchange="function1()">
                                            <label class="form-check-label" for="id_Checkbox1">Expand</label>
                                        </div>
                                    </div> 
                                </div>
                                <div class="col-md-2">    
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="id_Checkbox2">
                                            <label class="form-check-label" for="id_Checkbox2">Compact</label>
                                        </div>
                                    </div> 
                                </div>
                            </div>
...
<?php
    include './model-pages/mod_JobDetails.php'; 
?>    

<script src="js/mod_JobDetails.js"></script>
<!-- ChartJS -->
            ...
            {             
                ...
                {                     
                    ...
                    //var endDateTimeString = endDate.toISOString().slice(0, 16);
                     dataTable.addRow([row[0], row[5],startDate, endDate]);
                ...
                document.getElementById("id_charttitle").innerHTML = document.getElementById("id_SelMechanics").options[document.getElementById("id_SelMechanics").selectedIndex].text;
