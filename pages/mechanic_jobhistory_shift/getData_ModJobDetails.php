...
<?php    
    ...
    $TotalDownTime_ary         = array();
    $TotalAttendingTime_ary    = array();
    ...
    $stmt = $conn->prepare("
        SELECT 
            ...
            AllocatedUser,
            WoEventLog,
            TIMEDIFF(ClosedDateTime, CreatedDateTime) AS TotalDownTime,
            TIMEDIFF(RespondDateTime, CreatedDateTime) AS TotalAttendingTime
        FROM 
            tblwo_event 
        WHERE 
            WorkOrderNo =:wono");
    ...
    {           
        ...
        $TotalDownTime_ary[$i]      = $row['TotalDownTime'];
        $TotalAttendingTime_ary[$i] = $row['TotalAttendingTime'];                
        $i++;
    }             
    //----------- Load Arrays -------------------------
    ...
    $data_ary['TotalDownTime_Ary']      = $TotalDownTime_ary; 
    $data_ary['TotalAttendingTime_Ary'] = $TotalAttendingTime_ary; 
