...
{
    //writeToLogFile("test JS error message");
...
{
    //alert("Filter: Change Fault Type");
    const DataAry = []; 
    DataAry[0] = "Level1";        
    DataAry[1] = document.getElementById("id_ModWoClose_SelFaultType").value;    
    //alert(DataAry); 
...
{        
    //alert("Location : "+ "Wo Close Clicked..1");   
