        ...
        $.post('class/getData_HomeTable.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")
            {
                ...
                {       
                    ...
                    dtbl1.row.add([intX, res.Data_Ary[i][1], res.Data_Ary[i][3].substring(2, 16), res.Data_Ary[i][2], res.Data_Ary[i][8], res.Data_Ary[i][4], strDescription, res.Data_Ary[i][10],res.Data_Ary[i][12]]).draw(false);
                } 
            }
            else
            {
