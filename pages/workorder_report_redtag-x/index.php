    ...
    function funLoadBarChart() 
    {
        ...
        $.post('getData_RedTagReport.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                ...
                //-----------------------------------------------------------------------------------
                //- STACKED BAR CHART 1 - Line and Category Wise Downtime Stacked Chart
                //-----------------------------------------------------------------------------------
                ...
                var CategoryNameAry = ['Safty','Leakages','Rust/Corrosion','Contamination','Other'];

                //var LableAry = ['dep1', 'dep2', 'dep3', 'dep4', 'dep5', 'dep6' ];
                ...
                new Chart(stackedBarChartCanvas, 
                {
                    options: 
                    {
                        ...
                        {
                            // Change options for ALL labels of THIS CHART
                            datalabels: {color: '#000000', anchor: 'center', display: 'off', rotation:'0'}
                        }
                    },  
                    type: 'bar',
