...
<?php
    ...
    else if($strFuncType === "funGetFilteredData") //------------- funCheckUserCredentials --------------------
    {
        ...
        else if($intNoOfSearchParameters == 5) 
        {
            $strSearchField1 = $num[4]; 
            $strSearchValue1 = $num[5];            
            $strSearchField2 = $num[6]; 
            ...
            $strSearchField4 = $num[10]; 
            $strSearchValue4 = $num[11];            
            $strSearchField5 = $num[12]; 
            $strSearchValue5 = $num[13];            
            $strSQL = "SELECT DISTINCT " . $strFieldName . " FROM " . $strTableName . " WHERE " . $strSearchField1 . "='" . $strSearchValue1 . "' AND " . $strSearchField2 . "='" . $strSearchValue2 . "' AND " . $strSearchField3 . "='" . $strSearchValue3 . "' AND " . $strSearchField4 . "='" . $strSearchValue4 . "' AND " . $strSearchField5 . "='" . $strSearchValue5 . "'";
        }
        try 
        {
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);                       
