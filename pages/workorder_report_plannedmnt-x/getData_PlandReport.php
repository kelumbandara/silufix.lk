<?php
    ...
    if($strFuncType === "funGetData_PieChart1") //------------- funUpdateEventLog --------------------
    {
        ...
        $whereClause = "WorkOrderCategory = 'PlanMaintenance' AND State < 6 AND ClosedDateTime IS NOT NULL AND CreatedDateTime BETWEEN :sdate AND :edate";
    ...
    else if($strFuncType === "funGetData_Table") 
    {
        ...
        $whereClause = "wo.WorkOrderCategory = 'PlanMaintenance' AND State < 6 AND wo.ClosedDateTime IS NOT NULL AND wo.CreatedDateTime BETWEEN :sdate AND :edate";
