<?php
    ...
    if($strFuncType === "funGetData_PieChart1") //------------- funUpdateEventLog --------------------
    {
        ...
        $whereClause = "WorkOrderCategory = 'BuildingMaintenance' AND State < 6 AND ClosedDateTime IS NOT NULL AND CreatedDateTime BETWEEN :sdate AND :edate";
        ...
        {   
            ...
            {   
                $ReturnData_ary[0][0] = $row['Fabrication_Count'];
                $ReturnData_ary[0][1] = $row['Civil_Count']; 
                $ReturnData_ary[0][2] = $row['Plumbingh_Count']; 
                $ReturnData_ary[0][3] = $row['Other_Count'];
    ...
    else if($strFuncType === "funGetData_Table") 
    {
        ...
        $whereClause = "wo.WorkOrderCategory = 'BuildingMaintenance' AND State < 6 AND wo.ClosedDateTime IS NOT NULL AND wo.CreatedDateTime BETWEEN :sdate AND :edate";
