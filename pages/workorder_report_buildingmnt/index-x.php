                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default" >
                        <div class="card-header">
                            <h3 class="card-title">Building Maintenance</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card card-default" >                        
                                <div class="card-header">
                                    <h3 class="card-title">Building Maintenance Request by Departments</h3>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-minus"></i>
                                        </button>    
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card card-danger">  
                                        <div class="card-header">
                                            <h3 class="card-title"><b>Building Maintenance W/O Details</b></h3>                                    
                                        </div> 
                                    </div>
...
<script>
    ...
    { 
        ...
        $.post('getData_BmReport.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                ...
                const AryCheckIn_Lable      = ["Fabrication", "Civil", "Plumbing","Other"];
    ...
    function funLoadBarChart() 
    {
        ...
        $.post('getData_BmReport.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                ...
                document.getElementById("id_divBuildingMnt_chart3").innerHTML = '<canvas id="id_canBuildingMnt_chart3" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>';
                ...
                const AryCheckIn_Colors   = ["red","blue","green","#FFFF00","#FFA500","#FFFF00"];

                var donutChartCanvas = $('#id_canBuildingMnt_chart3').get(0).getContext('2d');               
                var donutData = {
                    labels: AryCheckIn_Lable,
                    datasets: [
                    {
